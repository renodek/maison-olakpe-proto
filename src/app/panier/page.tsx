  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <h1 className="font-serif text-3xl font-bold text-nuit dark:text-creme mb-8 flex items-center gap-2 animate-fade-in">
        <ShoppingBag className="w-7 h-7 text-rouge" />
        Mon Panier
      </h1>
      ...
      {items.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-4">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    <div className="flex items-center border border-sable/30 rounded-lg bg-creme dark:bg-nuit">
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center text-sm hover:text-rouge active:scale-90 transition-all"
                        aria-label="Diminuer"
                      >
            ...
            <Link
              href="/catalogue"
              className="inline-flex items-center gap-1 text-sm text-nuit/50 dark:text-creme/50 hover:text-rouge transition-colors"
            >
            ...
            <div className="sticky top-28 space-y-4 p-6 rounded-xl bg-ivoire dark:bg-nuit-light/50 border border-sable/10">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-creme dark:bg-nuit border border-sable/20 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-rouge focus:ring-1 focus:ring-or/30 transition-all"
                  />
                  <button
                    onClick={handleApplyCode}
                    className="px-3 py-2 bg-sable text-nuit rounded-lg text-xs font-bold hover:bg-rouge hover:text-creme hover:scale-105 active:scale-95 transition-all"
                  >
                    Appliquer
                  </button>
                </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-creme dark:bg-nuit border border-sable/20 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-rouge cursor-pointer"
                >
                  {carriers.map((c) => (
