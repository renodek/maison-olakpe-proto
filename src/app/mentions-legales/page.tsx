...
export const metadata: Metadata = { title: 'Mentions légales', description: 'Mentions légales du site' };
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="p-8 rounded-xl bg-ivoire dark:bg-nuit-light/50 text-center">
        ...
        <p className="text-xs text-nuit/30 dark:text-creme/30 mt-2">
          Cette page sera complétée avec les mentions légales définitives lors du développement de la version finale v1.0.
        </p>
      </div>
    </div>
  );
